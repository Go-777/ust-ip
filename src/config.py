...
class AgenticMemoryConfig:
    def __init__(self):
        ...
        self.selector_model = "qwen3.5-flash"  # Skill Selector model
        self.selector_api_base = None
        self.executor_model = "qwen3.5-flash"  # Executor model
        self.executor_api_base = None
        self.judge_model = "qwen3-max"  # QA Judge model (strongest for reward signal)
        self.judge_api_base = None
        self.designer_local_model = "qwen3.5-flash"  # Designer model
...
def get_agentic_memory_args():
    ...
    parser.add_argument('--selector-model', type=str, default='qwen3.5-flash',
    ...
    parser.add_argument('--executor-model', type=str, default='qwen3.5-flash',
